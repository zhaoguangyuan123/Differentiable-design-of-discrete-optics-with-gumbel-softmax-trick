...
class FresnelProp(nn.Module):
    ...
    The key property of implementation here is that the "u_in" and "u_out" planes have the same sampling interval.
    ...
    def __init__(self,
        ...
        self.output_field_shape = output_field_shape if output_field_shape is not None else input_field_shape
        ...
        if self.pre_compute_H:
            ...
            self.input_field_shape, self.input_dx, self.wave_lengths, self.response_type, self.pad_scale = input_field_shape, input_dx, wave_lengths, response_type, pad_scale
    ...
    def forward(self, u1, z=None):
        if z == 0. or self.z == 0.:
            ...
            u1 = circular_pad(u1, self.pad_scale)
